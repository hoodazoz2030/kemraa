...
@Module({
  imports: [
    ...
    NotificationsModule, SupportModule, LocationsModule, RedisModule, QueuesModule, RefundsModule, CommissionsModule, StaffModule, SettingsModule, PromosModule, ReviewsModule, DriversModule, AuditLogsModule, FeatureFlagsModule, SearchModule, PaymentsModule, AnalyticsModule,
  ],
  providers: [
