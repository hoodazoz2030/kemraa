                  ...
                  <tr key={u.id} className="hover:bg-gray-50/50 transition">
                    ...
                    <td className="px-4 py-3">
                      <div className="text-xs space-y-0.5">
                        ...
                        {u.phone && <div className="flex items-center gap-1 text-gray-600"><Phone size={11} /> {u.phone}</div>}
                      </div>
                    </td>
                    <td className="px-4 py-3">
            ...
            <div className="flex-1 overflow-y-auto p-5">
              {activeTab === "overview" && (
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-[10px] font-semibold text-gray-600 uppercase tracking-wider mb-2">Roles</p>
                  ...
                  <div className="grid grid-cols-4 gap-2 pt-2">
                    <div className="p-3 bg-gradient-to-br from-[#C9A227]/10 to-transparent rounded-lg text-center border border-[#C9A227]/20">
                      ...
                      <p className="text-[10px] text-gray-600 uppercase">Trips</p>
                    </div>
                    <div className="p-3 bg-gradient-to-br from-[#C9A227]/10 to-transparent rounded-lg text-center border border-[#C9A227]/20">
                      ...
                      <p className="text-[10px] text-gray-600 uppercase">Bookings</p>
                    </div>
                    <div className="p-3 bg-gradient-to-br from-[#C9A227]/10 to-transparent rounded-lg text-center border border-[#C9A227]/20">
                      ...
                      <p className="text-[10px] text-gray-600 uppercase">Tickets</p>
                    </div>
                    <div className="p-3 bg-gradient-to-br from-[#C9A227]/10 to-transparent rounded-lg text-center border border-[#C9A227]/20">
                      ...
                      <p className="text-[10px] text-gray-600 uppercase">Notifs</p>
                    </div>
                  </div>
                </div>
              )}
                      ...
                      <div key={b.id} className="p-3 border border-gray-200 rounded-lg">
                        <div className="flex items-center justify-between gap-2">
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-xs text-gray-600 mt-0.5">{b.service?.type ?? ""} • {new Date(b.createdAt).toLocaleDateString()}</p>
                          </div>
                          <div className="text-right shrink-0">
      ...
      {rolesModal && selected && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-2xl text-gray-900 w-full max-w-md shadow-xl border border-[#C9A227]/30">
            ...
            <div className="p-5">
              <p className="text-xs text-gray-600 mb-3">Select the roles for this user. Must have at least one role.</p>
